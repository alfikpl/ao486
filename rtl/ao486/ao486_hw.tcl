...
# 
# connection point debug_sw
# 
add_interface debug_sw conduit end
set_interface_property debug_sw associatedClock clock
set_interface_property debug_sw associatedReset ""
set_interface_property debug_sw ENABLED true
set_interface_property debug_sw EXPORT_OF ""
set_interface_property debug_sw PORT_NAME_MAP ""
set_interface_property debug_sw CMSIS_SVD_VARIABLES ""
set_interface_property debug_sw SVD_ADDRESS_GROUP ""

add_interface_port debug_sw SW export Input 18
...
# 
# connection point conduit_dbg
# 
add_interface conduit_dbg conduit end
set_interface_property conduit_dbg associatedClock clock
set_interface_property conduit_dbg associatedReset reset_only_ao486
set_interface_property conduit_dbg ENABLED true
set_interface_property conduit_dbg EXPORT_OF ""
set_interface_property conduit_dbg PORT_NAME_MAP ""
set_interface_property conduit_dbg CMSIS_SVD_VARIABLES ""
set_interface_property conduit_dbg SVD_ADDRESS_GROUP ""

add_interface_port conduit_dbg tb_finish_instr export Output 1
add_interface_port conduit_dbg dbg_io_address export Output 16
add_interface_port conduit_dbg dbg_io_byteenable export Output 4
add_interface_port conduit_dbg dbg_io_write export Output 1
add_interface_port conduit_dbg dbg_io_read export Output 1
add_interface_port conduit_dbg dbg_io_data export Output 32
add_interface_port conduit_dbg dbg_int_vector export Output 8
add_interface_port conduit_dbg dbg_int export Output 1
add_interface_port conduit_dbg dbg_exc_vector export Output 8
add_interface_port conduit_dbg dbg_exc export Output 1
add_interface_port conduit_dbg dbg_mem_address export Output 32
add_interface_port conduit_dbg dbg_mem_byteenable export Output 4
add_interface_port conduit_dbg dbg_mem_write export Output 1
add_interface_port conduit_dbg dbg_mem_read export Output 1
add_interface_port conduit_dbg dbg_mem_data export Output 32
