...
`define CMD_int_3 7'd20
`define CMD_SCAS 7'd14
`define CMD_int_2 7'd19
...
`define CMD_MUL 7'd60
`define CMD_CPUID 7'd82
...
`define CMD_STC 7'd28
`define CMDEX_IRET_2_protected_same_STEP_1 4'd2
`define CMD_STD 7'd29
`define CMD_LOOP 7'd59
