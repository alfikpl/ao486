//======================================================== conditions
wire cond_0 = dec_ready_one_one && decoder[7:0] == 8'hE3;
wire cond_1 = prefix_group_1_lock ;
wire cond_2 = dec_ready_2byte_modregrm && { decoder[7:1], 1'b0 } == 8'hC0;
...
wire cond_24 = dec_ready_one && decoder[7:4] == 4'h4;
wire cond_25 = dec_ready_modregrm_one && { decoder[7:1], 1'b0 } == 8'hFE && { decoder[13:12], 1'b0 } == 3'b000;
wire cond_26 = dec_ready_one && { decoder[7:1], 1'b0 } == 8'hAE;
wire cond_27 = dec_prefix_group_1_rep != 2'd0;
...
wire cond_31 = dec_ready_modregrm_one && decoder[7:0] == 8'h8E;
wire cond_32 = prefix_group_1_lock  || decoder[13:11] >= 3'd6 || decoder[13:11] == 3'd1;
wire cond_33 = dec_ready_2byte_modregrm && decoder[7:0] == 8'h00 && decoder[13:11] == 3'd2;
wire cond_34 = dec_ready_2byte_modregrm && decoder[7:0] == 8'h00 && decoder[13:11] == 3'd3;
wire cond_35 = (dec_ready_modregrm_one && (decoder[7:0] == 8'hC4 || decoder[7:0] == 8'hC5)) || (dec_ready_2byte_modregrm && (decoder[7:0] == 8'hB2 || decoder[7:0] == 8'hB4 || decoder[7:0] == 8'hB5));
...
wire cond_66 = dec_ready_2byte_modregrm && decoder[7:4] == 4'h9;
wire cond_67 = dec_ready_one && decoder[7:0] == 8'h9B;
wire cond_68 = dec_ready_modregrm_one && { decoder[7:3], 3'b0 } == 8'hD8;
wire cond_69 = dec_ready_one_three && decoder[7:0] == 8'hC8;
wire cond_70 = dec_ready_2byte_modregrm && { decoder[7:1], 1'b0 } == 8'hB0;
...
wire cond_73 = (dec_ready_2byte_modregrm && decoder[7:0] == 8'hA5) || (dec_ready_2byte_modregrm_imm && decoder[7:0] == 8'hA4);
wire cond_74 = decoder[0];
wire cond_75 = (dec_ready_2byte_modregrm && decoder[7:0] == 8'hAD) || (dec_ready_2byte_modregrm_imm && decoder[7:0] == 8'hAC);
wire cond_76 = dec_ready_one && decoder[7:0] == 8'hC9;
...
wire cond_83 = dec_ready_one_one && (decoder[7:0] == 8'hE0 || decoder[7:0] == 8'hE1 || decoder[7:0] == 8'hE2);
wire cond_84 = dec_ready_modregrm_one && { decoder[7:1], 1'b0 } == 8'hF6 && decoder[13:11] == 3'd4;
...
wire cond_98 = (dec_ready_one && { decoder[7:1], 1'b0 } == 8'hEC) || (dec_ready_one_one && { decoder[7:1], 1'b0 } == 8'hE4);
wire cond_99 = decoder[3];
wire cond_100 = decoder[3] == 1'b1;
wire cond_101 = dec_ready_2byte_modregrm && decoder[7:0] == 8'h00 && decoder[13:11] == 3'd4;
wire cond_102 = dec_ready_2byte_modregrm && decoder[7:0] == 8'h00 && decoder[13:11] == 3'd5;
wire cond_103 = dec_ready_2byte_modregrm && decoder[7:0] == 8'h02;
wire cond_104 = dec_ready_2byte_modregrm && decoder[7:0] == 8'h03;
wire cond_105 = dec_ready_modregrm_one && { decoder[7:1], 1'b0 } == 8'hF6 && decoder[13:11] == 3'd2;
wire cond_106 = dec_ready_2byte_one && decoder[7:0] == 8'hA2;
wire cond_107 = dec_ready_one && { decoder[7:1], 1'b0 } == 8'hAA;
wire cond_108 = dec_ready_one && { decoder[7:1], 1'b0 } == 8'h6C;
wire cond_109 = dec_ready_one && decoder[7:0] == 8'h9C;
wire cond_110 = dec_ready_one && { decoder[7:1], 1'b0 } == 8'h6E;
...
assign dec_is_complex =
    ...
    (cond_23 && ~cond_1)? (`TRUE) :
    (cond_26 && ~cond_1 && cond_27)? (`TRUE) :
    (cond_28 && ~cond_1)? (`TRUE) :
    (cond_31 && ~cond_32)? (`TRUE) :
    (cond_33 && ~cond_14)? (`TRUE) :
    (cond_34 && ~cond_14)? (`TRUE) :
    (cond_35 && ~cond_22)? (`TRUE) :
    (cond_44 && ~cond_1)? (`TRUE) :
    (cond_49 && ~cond_1)? (`TRUE) :
    (cond_52 && ~cond_1)? (`TRUE) :
    (cond_58 && ~cond_1)? (`TRUE) :
    ...
    (cond_88 && ~cond_1)? (`TRUE) :
    (cond_89 && ~cond_1)? (`TRUE) :
    (cond_90 && ~cond_1 && cond_27)? (`TRUE) :
    (cond_92 && ~cond_3)? (`TRUE) :
    (cond_96 && ~cond_1)? (`TRUE) :
    (cond_98 && ~cond_1)? (`TRUE) :
    (cond_101 && ~cond_14)? (`TRUE) :
    (cond_102 && ~cond_14)? (`TRUE) :
    (cond_103 && ~cond_14)? (`TRUE) :
    (cond_104 && ~cond_14)? (`TRUE) :
    (cond_106 && ~cond_1)? (`TRUE) :
    (cond_107 && ~cond_1 && cond_27)? (`TRUE) :
    (cond_108 && ~cond_1)? (`TRUE) :
    ...
    (cond_132 && ~cond_1 && cond_27)? (`TRUE) :
    (cond_135 && ~cond_1)? (`TRUE) :
    (cond_136 && ~cond_1 && cond_56)? (`TRUE) :
    1'd0;
assign dec_cmd =
    (cond_0 && ~cond_1)? ( `CMD_JCXZ) :
    (cond_2 && ~cond_3)? ( `CMD_XADD) :
    (cond_5 && ~cond_1)? ( `CMD_CALL) :
    (cond_7 && ~cond_8)? ( `CMD_CALL) :
    (cond_10 && ~cond_1)? ( `CMD_PUSH_MOV_SEG) :
    (cond_11 && ~cond_12)? ( `CMD_PUSH_MOV_SEG) :
    (cond_13 && ~cond_14)? ( `CMD_PUSH_MOV_SEG) :
    (cond_15 && ~cond_14)? ( `CMD_PUSH_MOV_SEG) :
    (cond_16 && ~cond_3)? ( `CMD_NEG) :
    (cond_17 && ~cond_1)? ( `CMD_Jcc) :
    (cond_20 && ~cond_1)? ( `CMD_INVD) :
    (cond_21 && ~cond_22)? ( `CMD_INVLPG) :
    (cond_23 && ~cond_1)? ( `CMD_HLT) :
    (cond_24 && ~cond_1)? ( `CMD_INC_DEC) :
    (cond_25 && ~cond_3)? ( `CMD_INC_DEC) :
    (cond_26 && ~cond_1)? ( `CMD_SCAS) :
    (cond_28 && ~cond_1)? ( `CMD_RET_near) :
    (cond_29 && ~cond_14)? ( `CMD_ARPL) :
    (cond_30 && ~cond_1)? ( `CMD_BSWAP) :
    (cond_31 && ~cond_32)? ( `CMD_MOV_to_seg) :
    (cond_33 && ~cond_14)? ( `CMD_LLDT) :
    (cond_34 && ~cond_14)? ( `CMD_LTR) :
    (cond_35 && ~cond_22)? ( `CMD_LxS) :
    (cond_36 && ~cond_1)? ( `CMD_CLC) :
    (cond_37 && ~cond_1)? ( `CMD_CLD) :
    (cond_38 && ~cond_1)? ( `CMD_CMC) :
    (cond_39 && ~cond_1)? ( `CMD_STC) :
    (cond_40 && ~cond_1)? ( `CMD_STD) :
    (cond_41 && ~cond_1)? ( `CMD_SAHF) :
    (cond_42 && ~cond_1)? ( `CMD_AAD) :
    (cond_43 && ~cond_1)? ( `CMD_AAM) :
    (cond_44 && ~cond_1)? ( `CMD_POP_seg) :
    (cond_45 && ~cond_1)? ( `CMD_BT) :
    (cond_46 && ~cond_3)? ( `CMD_BTR) :
    (cond_47 && ~cond_3)? ( `CMD_BTS) :
    (cond_48 && ~cond_3)? ( `CMD_BTC) :
    (cond_49 && ~cond_1)? ( `CMD_IRET) :
    (cond_51 && ~cond_1)? ( `CMD_POP) :
    (cond_52 && ~cond_1)? ( `CMD_POP) :
    (cond_53 && ~cond_1)? ( `CMD_DIV) :
    (cond_54 && ~cond_1)? ( `CMD_IDIV) :
    (cond_55 && ~cond_1)? ( `CMD_Shift) :
    (cond_57 && ~cond_1)? ( `CMD_Shift) :
    (cond_58 && ~cond_1)? ( `CMD_CMPS) :
    (cond_59 && ~cond_1)? ( `CMD_control_reg) :
    (cond_60 && ~cond_1)? ( `CMD_control_reg) :
    (cond_61 && ~cond_62)? ( `CMD_control_reg) :
    (cond_63 && ~cond_22)? ( `CMD_LGDT) :
    (cond_64 && ~cond_22)? ( `CMD_LIDT) :
    (cond_65 && ~cond_1)? ( `CMD_PUSHA) :
    (cond_66 && ~cond_1)? ( `CMD_SETcc) :
    (cond_67 && ~cond_1)? ( `CMD_fpu) :
    (cond_68 && ~cond_1)? ( `CMD_fpu) :
    (cond_69 && ~cond_1)? ( `CMD_ENTER) :
    (cond_70 && ~cond_3)? ( `CMD_CMPXCHG) :
    (cond_71 && ~cond_1)? ( `CMD_IMUL) :
    (cond_72 && ~cond_1)? ( `CMD_IMUL) :
    (cond_73 && ~cond_1)? ( `CMD_SHLD) :
    (cond_75 && ~cond_1)? ( `CMD_SHRD) :
    (cond_76 && ~cond_1)? ( `CMD_LEAVE) :
    (cond_77 && ~cond_1)? ( `CMD_WBINVD) :
    (cond_78 && ~cond_1)? ( {`CMD_Arith | { 4'd0, decoder[5:3] } }) :
    (cond_79 && ~cond_80)? ( {`CMD_Arith | { 4'd0, decoder[5:3] } }) :
    (cond_81 && ~cond_82)? ( {`CMD_Arith | { 4'd0, decoder[13:11] } }) :
    (cond_83 && ~cond_1)? ( `CMD_LOOP) :
    (cond_84 && ~cond_1)? ( `CMD_MUL) :
    (cond_85 && ~cond_1)? ( `CMD_TEST) :
    (cond_86 && ~cond_1)? ( `CMD_TEST) :
    (cond_87 && ~cond_1)? ( `CMD_TEST) :
    (cond_88 && ~cond_1)? ( `CMD_CLTS) :
    (cond_89 && ~cond_1)? ( `CMD_RET_far) :
    (cond_90 && ~cond_1)? ( `CMD_LODS) :
    (cond_91 && ~cond_1)? ( `CMD_XCHG) :
    (cond_92 && ~cond_3)? ( `CMD_XCHG) :
    (cond_93 && ~cond_1)? ( `CMD_PUSH) :
    (cond_94 && ~cond_1)? ( `CMD_PUSH) :
    (cond_95 && ~cond_1)? ( `CMD_PUSH) :
    (cond_96 && ~cond_1)? ( `CMD_INT_INTO) :
    (cond_98 && ~cond_1)? ( `CMD_IN) :
    (cond_101 && ~cond_14)? ( `CMD_VERR) :
    (cond_102 && ~cond_14)? ( `CMD_VERW) :
    (cond_103 && ~cond_14)? ( `CMD_LAR) :
    (cond_104 && ~cond_14)? ( `CMD_LSL) :
    (cond_105 && ~cond_3)? ( `CMD_NOT) :
    (cond_106 && ~cond_1)? ( `CMD_CPUID) :
    (cond_107 && ~cond_1)? ( `CMD_STOS) :
    (cond_108 && ~cond_1)? ( `CMD_INS) :
    (cond_109 && ~cond_1)? ( `CMD_PUSHF) :
    (cond_110 && ~cond_1)? ( `CMD_OUTS) :
    (cond_111 && ~cond_1)? ( `CMD_JMP) :
    (cond_113 && ~cond_114)? ( `CMD_JMP) :
    (cond_115 && ~cond_1)? ( `CMD_OUT) :
    (cond_116 && ~cond_1)? ( `CMD_MOV) :
    (cond_117 && ~cond_1)? ( `CMD_MOV) :
    (cond_119 && ~cond_1)? ( `CMD_MOV) :
    (cond_120 && ~cond_1)? ( `CMD_MOV) :
    (cond_121 && ~cond_1)? ( `CMD_LAHF) :
    (cond_122 && ~cond_1)? ( `CMD_CBW) :
    (cond_123 && ~cond_1)? ( `CMD_CWD) :
    (cond_124 && ~cond_1)? ( `CMD_POPF) :
    (cond_125 && ~cond_1)? ( `CMD_CLI) :
    (cond_126 && ~cond_1)? ( `CMD_STI) :
    (cond_127 && ~cond_22)? ( `CMD_BOUND) :
    (cond_128 && ~cond_1)? ( `CMD_SALC) :
    (cond_129 && ~cond_22)? ( `CMD_LEA) :
    (cond_130 && ~cond_22)? ( `CMD_SGDT) :
    (cond_131 && ~cond_22)? ( `CMD_SIDT) :
    (cond_132 && ~cond_1)? ( `CMD_MOVS) :
    (cond_133 && ~cond_1)? ( `CMD_MOVZX) :
    (cond_134 && ~cond_1)? ( `CMD_MOVSX) :
    (cond_135 && ~cond_1)? ( `CMD_POPA) :
    (cond_136 && ~cond_1)? ( `CMD_debug_reg) :
    (cond_137 && ~cond_1)? ( `CMD_XLAT) :
    (cond_138 && ~cond_1)? ( `CMD_AAA) :
    (cond_139 && ~cond_1)? ( `CMD_AAS) :
    (cond_140 && ~cond_1)? ( `CMD_DAA) :
    (cond_141 && ~cond_1)? ( `CMD_DAS) :
    (cond_142 && ~cond_1)? ( `CMD_BSF) :
    (cond_143 && ~cond_1)? ( `CMD_BSR) :
    7'd0;
assign consume_one_two =
    (cond_28 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_89 && ~cond_1 && cond_4)? (`TRUE) :
    1'd0;
assign consume_modregrm_imm =
    (cond_45 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_46 && ~cond_3 && cond_4)? (`TRUE) :
    (cond_47 && ~cond_3 && cond_4)? (`TRUE) :
    (cond_48 && ~cond_3 && cond_4)? (`TRUE) :
    (cond_57 && ~cond_1)? (`TRUE) :
    (cond_72 && ~cond_1)? (`TRUE) :
    (cond_73 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_75 && ~cond_1 && cond_4)? (`TRUE) :
...
assign consume_one =
    ...
    (cond_91 && ~cond_1)? (`TRUE) :
    (cond_93 && ~cond_1)? (`TRUE) :
    (cond_96 && ~cond_1 && cond_97)? (`TRUE) :
    (cond_98 && ~cond_1 && cond_100)? (`TRUE) :
    (cond_106 && ~cond_1)? (`TRUE) :
    (cond_107 && ~cond_1)? (`TRUE) :
    (cond_108 && ~cond_1)? (`TRUE) :
    (cond_109 && ~cond_1)? (`TRUE) :
    (cond_110 && ~cond_1)? (`TRUE) :
    (cond_115 && ~cond_1 && cond_100)? (`TRUE) :
    (cond_121 && ~cond_1)? (`TRUE) :
    ...
    (cond_141 && ~cond_1)? (`TRUE) :
    1'd0;
assign consume_one_one =
    (cond_0 && ~cond_1)? (`TRUE) :
    (cond_17 && ~cond_1 && ~cond_19)? (`TRUE) :
    (cond_42 && ~cond_1)? (`TRUE) :
    (cond_43 && ~cond_1)? (`TRUE) :
    (cond_83 && ~cond_1)? (`TRUE) :
    (cond_96 && ~cond_1 && ~cond_97)? (`TRUE) :
...
assign dec_is_8bit =
    ...
    (cond_16 && ~cond_3 && cond_4)? (`TRUE) :
    (cond_17 && ~cond_1 && cond_18)? (`TRUE) :
    (cond_25 && ~cond_3 && cond_4)? (`TRUE) :
    (cond_26 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_42 && ~cond_1)? (`TRUE) :
    (cond_43 && ~cond_1)? (`TRUE) :
    (cond_53 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_54 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_55 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_57 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_58 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_66 && ~cond_1)? (`TRUE) :
    (cond_70 && ~cond_3 && cond_4)? (`TRUE) :
    (cond_71 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_78 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_79 && ~cond_80 && cond_4)? (`TRUE) :
    (cond_81 && ~cond_82 && cond_4)? (`TRUE) :
    (cond_83 && ~cond_1)? (`TRUE) :
    (cond_84 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_85 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_86 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_87 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_90 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_92 && ~cond_3 && cond_4)? (`TRUE) :
    (cond_98 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_105 && ~cond_3 && cond_4)? (`TRUE) :
    (cond_107 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_108 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_110 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_111 && ~cond_1 && cond_112)? (`TRUE) :
    (cond_115 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_116 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_117 && ~cond_1 && cond_118)? (`TRUE) :
    (cond_119 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_120 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_132 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_133 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_134 && ~cond_1 && cond_4)? (`TRUE) :
    (cond_137 && ~cond_1)? (`TRUE) :
    (cond_138 && ~cond_1)? (`TRUE) :
    (cond_139 && ~cond_1)? (`TRUE) :
    (cond_140 && ~cond_1)? (`TRUE) :
    ...
    1'd0;
assign dec_cmdex =
    (cond_5 && ~cond_1 && cond_6)? ( `CMDEX_CALL_Jv_STEP_0) :
    (cond_5 && ~cond_1 && ~cond_6)? ( `CMDEX_CALL_Ap_STEP_0) :
    (cond_7 && ~cond_8 && cond_9)? ( `CMDEX_CALL_Ev_STEP_0) :
    (cond_7 && ~cond_8 && ~cond_9)? ( `CMDEX_CALL_Ep_STEP_0) :
    (cond_10 && ~cond_1)? ( `CMDEX_PUSH_MOV_SEG_implicit | { 1'b0, decoder[5:3] }) :
    ...
    (cond_20 && ~cond_1)? ( `CMDEX_INVD_STEP_0) :
    (cond_21 && ~cond_22)? ( `CMDEX_INVLPG_STEP_0) :
    (cond_23 && ~cond_1)? ( `CMDEX_HLT_STEP_0) :
    (cond_24 && ~cond_1)? ( `CMDEX_INC_DEC_increment_implicit | { 3'd0, decoder[3] }) :
    (cond_25 && ~cond_3)? ( `CMDEX_INC_DEC_increment_modregrm | { 3'd0, decoder[11] }) :
    (cond_26 && ~cond_1)? ( `CMDEX_SCAS_STEP_0) :
    (cond_28 && ~cond_1 && cond_4)? ( `CMDEX_RET_near_imm) :
    (cond_28 && ~cond_1 && ~cond_4)? ( `CMDEX_RET_near) :
    (cond_31 && ~cond_32)? ( `CMDEX_MOV_to_seg_LLDT_LTR_STEP_1) :
    (cond_33 && ~cond_14)? ( `CMDEX_MOV_to_seg_LLDT_LTR_STEP_1) :
    (cond_34 && ~cond_14)? ( `CMDEX_MOV_to_seg_LLDT_LTR_STEP_1) :
    (cond_35 && ~cond_22)? ( `CMDEX_LxS_STEP_1) :
    (cond_44 && ~cond_1)? ( `CMDEX_POP_seg_STEP_1) :
    (cond_45 && ~cond_1 && cond_4)? ( `CMDEX_BTx_modregrm_imm) :
    (cond_45 && ~cond_1 && ~cond_4)? ( `CMDEX_BTx_modregrm) :
    (cond_46 && ~cond_3 && cond_4)? ( `CMDEX_BTx_modregrm_imm) :
    (cond_46 && ~cond_3 && ~cond_4)? ( `CMDEX_BTx_modregrm) :
    (cond_47 && ~cond_3 && cond_4)? ( `CMDEX_BTx_modregrm_imm) :
    (cond_47 && ~cond_3 && ~cond_4)? ( `CMDEX_BTx_modregrm) :
    (cond_48 && ~cond_3 && cond_4)? ( `CMDEX_BTx_modregrm_imm) :
    (cond_48 && ~cond_3 && ~cond_4)? ( `CMDEX_BTx_modregrm) :
    (cond_49 && ~cond_1 && cond_50)? ( `CMDEX_IRET_real_v86_STEP_0) :
    (cond_49 && ~cond_1 && ~cond_50)? ( `CMDEX_IRET_protected_STEP_0) :
    (cond_51 && ~cond_1)? ( `CMDEX_POP_implicit) :
    (cond_52 && ~cond_1)? ( `CMDEX_POP_modregrm_STEP_0) :
    (cond_55 && ~cond_1 && cond_56)? ( `CMDEX_Shift_implicit) :
    (cond_55 && ~cond_1 && ~cond_56)? ( `CMDEX_Shift_modregrm) :
    (cond_57 && ~cond_1)? ( `CMDEX_Shift_modregrm_imm) :
    (cond_58 && ~cond_1)? (`CMDEX_CMPS_FIRST) :
    (cond_59 && ~cond_1)? ( `CMDEX_control_reg_SMSW_STEP_0) :
    (cond_60 && ~cond_1)? ( `CMDEX_control_reg_LMSW_STEP_0) :
    ...
    (cond_65 && ~cond_1)? ( `CMDEX_PUSHA_STEP_0) :
    (cond_67 && ~cond_1)? ( `CMDEX_WAIT_STEP_0) :
    (cond_68 && ~cond_1)? ( `CMDEX_ESC_STEP_0) :
    (cond_69 && ~cond_1)? ( `CMDEX_ENTER_FIRST) :
    (cond_71 && ~cond_1)? ( `CMDEX_IMUL_modregrm) :
    (cond_72 && ~cond_1)? ( `CMDEX_IMUL_modregrm_imm) :
    (cond_73 && ~cond_1 && cond_74)? ( `CMDEX_SHxD_implicit) :
    (cond_73 && ~cond_1 && ~cond_74)? ( `CMDEX_SHxD_modregrm_imm) :
    (cond_75 && ~cond_1 && cond_74)? ( `CMDEX_SHxD_implicit) :
    (cond_75 && ~cond_1 && ~cond_74)? ( `CMDEX_SHxD_modregrm_imm) :
    (cond_77 && ~cond_1)? ( `CMDEX_WBINVD_STEP_0) :
    (cond_78 && ~cond_1)? ( `CMDEX_Arith_immediate) :
    (cond_79 && ~cond_80)? ( `CMDEX_Arith_modregrm) :
    (cond_81 && ~cond_82)? ( `CMDEX_Arith_modregrm_imm) :
    (cond_83 && ~cond_1)? ( (decoder[1:0] == 2'b00)? `CMDEX_LOOP_NE : (decoder[1:0] == 2'b01)? `CMDEX_LOOP_E : `CMDEX_LOOP) :
    (cond_85 && ~cond_1)? ( `CMDEX_TEST_immediate) :
    (cond_86 && ~cond_1)? ( `CMDEX_TEST_modregrm) :
    (cond_87 && ~cond_1)? ( `CMDEX_TEST_modregrm_imm) :
    (cond_88 && ~cond_1)? (`CMDEX_CLTS_STEP_FIRST) :
    (cond_89 && ~cond_1)? ( `CMDEX_RET_far_STEP_1) :
    (cond_90 && ~cond_1)? ( `CMDEX_LODS_STEP_0) :
    (cond_91 && ~cond_1)? ( `CMDEX_XCHG_implicit) :
    (cond_92 && ~cond_3)? ( `CMDEX_XCHG_modregrm) :
    (cond_93 && ~cond_1)? ( `CMDEX_PUSH_implicit) :
    (cond_94 && ~cond_1 && cond_56)? ( `CMDEX_PUSH_immediate_se) :
    (cond_94 && ~cond_1 && ~cond_56)? ( `CMDEX_PUSH_immediate) :
    (cond_95 && ~cond_1)? ( `CMDEX_PUSH_modregrm) :
    (cond_96 && ~cond_1)? ( (decoder[2:0] == 3'b100)? `CMDEX_INT_INTO_INT3_STEP_0 : (decoder[2:0] == 3'b101)? `CMDEX_INT_INTO_INT_STEP_0 : (decoder[2:0] == 3'b110)? `CMDEX_INT_INTO_INTO_STEP_0 : `CMDEX_INT_INTO_INT1_STEP_0) :
    (cond_98 && ~cond_1 && cond_99)? ( `CMDEX_IN_dx) :
    (cond_98 && ~cond_1 && ~cond_99)? ( `CMDEX_IN_imm) :
    (cond_101 && ~cond_14)? ( `CMDEX_LAR_LSL_VERR_VERW_STEP_1) :
    (cond_102 && ~cond_14)? ( `CMDEX_LAR_LSL_VERR_VERW_STEP_1) :
    (cond_103 && ~cond_14)? (`CMDEX_LAR_LSL_VERR_VERW_STEP_1) :
    (cond_104 && ~cond_14)? ( `CMDEX_LAR_LSL_VERR_VERW_STEP_1) :
    (cond_106 && ~cond_1)? ( `CMDEX_CPUID_STEP_LAST) :
    (cond_107 && ~cond_1)? ( `CMDEX_STOS_STEP_0) :
    (cond_108 && ~cond_1)? ( `CMDEX_INS_real_1) :
    (cond_110 && ~cond_1)? ( `CMDEX_OUTS_first) :
    (cond_111 && ~cond_1 && cond_4)? ( `CMDEX_JMP_Ap_STEP_0) :
    (cond_111 && ~cond_1 && ~cond_4)? ( `CMDEX_JMP_Jv_STEP_0) :
    (cond_113 && ~cond_114 && cond_9)? ( `CMDEX_JMP_Ev_STEP_0) :
    (cond_113 && ~cond_114 && ~cond_9)? ( `CMDEX_JMP_Ep_STEP_0) :
    (cond_115 && ~cond_1 && cond_99)? ( `CMDEX_OUT_dx) :
    (cond_115 && ~cond_1 && ~cond_99)? ( `CMDEX_OUT_imm) :
    (cond_116 && ~cond_1)? ( `CMDEX_MOV_memoffset) :
    (cond_117 && ~cond_1)? ( `CMDEX_MOV_immediate) :
    (cond_119 && ~cond_1)? ( `CMDEX_MOV_modregrm) :
    (cond_120 && ~cond_1)? ( `CMDEX_MOV_modregrm_imm) :
    (cond_124 && ~cond_1)? ( `CMDEX_POPF_STEP_0) :
    (cond_127 && ~cond_22)? ( `CMDEX_BOUND_STEP_FIRST) :
    (cond_128 && ~cond_1)? ( `CMDEX_SALC_STEP_0) :
    (cond_130 && ~cond_22)? ( `CMDEX_SGDT_SIDT_STEP_1) :
    (cond_131 && ~cond_22)? ( `CMDEX_SGDT_SIDT_STEP_1) :
    (cond_132 && ~cond_1)? ( `CMDEX_MOVS_STEP_0) :
    (cond_135 && ~cond_1)? ( `CMDEX_POPA_STEP_0) :
    (cond_136 && ~cond_1 && cond_56)? ( `CMDEX_debug_reg_MOV_load_STEP_0) :
    (cond_136 && ~cond_1 && ~cond_56)? ( `CMDEX_debug_reg_MOV_store_STEP_0) :
    4'd0;
