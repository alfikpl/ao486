...
//======================================================== conditions
wire cond_0 = wr_cmd == `CMD_JCXZ;
wire cond_1 = result_signals[0];
wire cond_2 = wr_cmd == `CMD_XADD && wr_cmdex == `CMDEX_XADD_FIRST;
wire cond_3 = wr_dst_is_memory && ~(write_for_wr_ready);
wire cond_4 = wr_cmd == `CMD_XADD && wr_cmdex == `CMDEX_XADD_LAST;
wire cond_5 = wr_modregrm_mod != 2'b11 || wr_modregrm_reg != wr_modregrm_rm;
...
wire cond_32 = wr_cmd == `CMD_INC_DEC;
wire cond_33 = wr_cmd == `CMD_SCAS;
wire cond_34 = ~(wr_string_ignore);
wire cond_35 = wr_prefix_group_1_rep != 2'd0;
wire cond_36 = wr_string_ignore || wr_string_zf_finish;
wire cond_37 = ~(wr_string_ignore) && ~(wr_string_zf_finish) && wr_prefix_group_1_rep != 2'd0;
wire cond_38 = wr_cmd == `CMD_RET_near && wr_cmdex != `CMDEX_RET_near_LAST;
wire cond_39 = wr_cmd == `CMD_ARPL;
wire cond_40 = wr_cmd == `CMD_BSWAP;
wire cond_41 = wr_cmd == `CMD_int_2  && wr_cmdex == `CMDEX_int_2_int_trap_gate_more_STEP_2;
wire cond_42 = wr_cmd == `CMD_int_2  && wr_cmdex == `CMDEX_int_2_int_trap_gate_more_STEP_3;
wire cond_43 = wr_cmd == `CMD_int_2 && ( wr_cmdex == `CMDEX_int_2_int_trap_gate_more_STEP_4 || wr_cmdex == `CMDEX_int_2_int_trap_gate_more_STEP_5 || wr_cmdex == `CMDEX_int_2_int_trap_gate_more_STEP_6 || wr_cmdex == `CMDEX_int_2_int_trap_gate_more_STEP_7 || wr_cmdex == `CMDEX_int_2_int_trap_gate_more_STEP_8 || wr_cmdex == `CMDEX_int_2_int_trap_gate_more_STEP_9);
wire cond_44 = wr_cmd == `CMD_int_3 && ( wr_cmdex == `CMDEX_int_3_int_trap_gate_more_STEP_0 || wr_cmdex == `CMDEX_int_3_int_trap_gate_more_STEP_1 || wr_cmdex == `CMDEX_int_3_int_trap_gate_more_STEP_2 || wr_cmdex == `CMDEX_int_3_int_trap_gate_more_STEP_3);
wire cond_45 = (wr_cmdex == `CMDEX_int_3_int_trap_gate_more_STEP_2 && ~(exc_push_error)) || wr_cmdex == `CMDEX_int_3_int_trap_gate_more_STEP_3;
wire cond_46 = wr_cmd == `CMD_int && wr_cmdex == `CMDEX_int_STEP_0;
wire cond_47 = wr_cmd == `CMD_int && wr_cmdex == `CMDEX_int_STEP_1;
wire cond_48 = wr_cmd == `CMD_int && (wr_cmdex == `CMDEX_int_real_STEP_3 || wr_cmdex == `CMDEX_int_real_STEP_4);
wire cond_49 = wr_cmd == `CMD_int && wr_cmdex == `CMDEX_int_real_STEP_5;
wire cond_50 = wr_cmd == `CMD_int && (wr_cmdex == `CMDEX_int_protected_STEP_0 || wr_cmdex == `CMDEX_int_protected_STEP_1 || wr_cmdex == `CMDEX_int_protected_STEP_2);
wire cond_51 = wr_cmd == `CMD_int_2 && wr_cmdex == `CMDEX_int_2_int_trap_gate_same_STEP_5;
wire cond_52 = wr_cmd == `CMD_int_3 && wr_cmdex == `CMDEX_int_3_int_trap_gate_more_STEP_6;
wire cond_53 = v8086_mode;
wire cond_54 = wr_cmd == `CMD_int && (wr_cmdex == `CMDEX_int_real_STEP_0 || wr_cmdex == `CMDEX_int_real_STEP_1 || wr_cmdex == `CMDEX_int_real_STEP_2);
...
wire cond_58 = wr_cmd == `CMD_LxS && wr_cmdex != `CMDEX_LxS_STEP_LAST;
wire cond_59 = wr_cmd == `CMD_LxS && wr_cmdex == `CMDEX_LxS_STEP_LAST;
wire cond_60 = wr_cmd == `CMD_CLC;
wire cond_61 = wr_cmd == `CMD_CMC;
wire cond_62 = wr_cmd == `CMD_CLD;
wire cond_63 = wr_cmd == `CMD_STC;
wire cond_64 = wr_cmd == `CMD_STD;
wire cond_65 = wr_cmd == `CMD_SAHF;
...
wire cond_129 = wr_cmd == `CMD_ENTER && wr_cmdex == `CMDEX_ENTER_FIRST;
wire cond_130 = wr_cmd == `CMD_ENTER && wr_cmdex == `CMDEX_ENTER_LAST;
wire cond_131 = wr_cmd == `CMD_ENTER && (wr_cmdex == `CMDEX_ENTER_PUSH || wr_cmdex == `CMDEX_ENTER_LOOP);
wire cond_132 = wr_cmd == `CMD_CMPXCHG;
wire cond_133 = wr_cmd == `CMD_IMUL;
wire cond_134 = wr_dst_is_edx_eax;
wire cond_135 = { wr_cmd[6:1], 1'd0 } == `CMD_SHxD;
wire cond_136 = wr_cmd == `CMD_LEAVE;
...
wire cond_142 = wr_cmd == `CMD_LOOP;
wire cond_143 = wr_address_16bit;
wire cond_144 = wr_cmd == `CMD_MUL;
...
wire cond_163 = oflag;
wire cond_164 = wr_cmd == `CMD_IN;
wire cond_165 = ~(io_allow_check_needed) || wr_cmdex == `CMDEX_IN_protected;
wire cond_166 = (wr_cmd == `CMD_LAR || wr_cmd == `CMD_LSL || wr_cmd == `CMD_VERR || wr_cmd == `CMD_VERW) && (wr_cmdex == `CMDEX_LAR_LSL_VERR_VERW_STEP_1 || wr_cmdex == `CMDEX_LAR_LSL_VERR_VERW_STEP_2);
wire cond_167 = (wr_cmd == `CMD_LAR || wr_cmd == `CMD_LSL) && wr_cmdex == `CMDEX_LAR_LSL_VERR_VERW_STEP_LAST;
wire cond_168 = wr_dst_is_reg;
wire cond_169 = (wr_cmd == `CMD_VERR || wr_cmd == `CMD_VERW) && wr_cmdex == `CMDEX_LAR_LSL_VERR_VERW_STEP_LAST;
wire cond_170 = wr_cmd == `CMD_NOT;
wire cond_171 = wr_cmd == `CMD_CPUID;
wire cond_172 = eax == 32'd0;
wire cond_173 = eax != 32'd0;
...
wire cond_199 = wr_cmd == `CMD_PUSHF;
wire cond_200 = wr_cmd == `CMD_OUTS;
wire cond_201 = io_allow_check_needed && wr_cmdex == `CMDEX_OUTS_first;
wire cond_202 = ~(write_io_for_wr_ready);
...
assign zflag_to_reg =
    ...
    (cond_32)? ( zflag_result) :
    (cond_33 && cond_34)? ( zflag_result) :
    (cond_39 && cond_1)? ( `TRUE) :
    (cond_39 && ~cond_1)? ( `FALSE) :
    (cond_65)? ( eax[14]) :
    ...
    (cond_107 && cond_34)? ( zflag_result) :
    (cond_132 && cond_1)? ( `TRUE) :
    (cond_132 && ~cond_1)? ( zflag_result) :
    (cond_133)? ( zflag_result) :
    (cond_135 && cond_104)? ( zflag_result) :
    (cond_139)? ( zflag_result) :
    (cond_144)? ( zflag_result) :
    (cond_145)? ( zflag_result) :
    (cond_167 && cond_168)? ( `TRUE) :
    (cond_167 && ~cond_168)? ( `FALSE) :
    (cond_169)? ( wr_dst_is_reg) :
    (cond_216)? (  result2[6]) :
    (cond_240)? (  task_eflags[6]) :
    (cond_272)? ( zflag_result) :
    (cond_273)? ( zflag_result) :
    (cond_274 && cond_1)? ( `TRUE) :
    (cond_274 && ~cond_1)? ( `FALSE) :
    zflag;
...
assign esp_to_reg =
    ...
    (cond_44 && cond_15 && cond_45)? ( wr_new_stack_esp) :
    (cond_54 && cond_10)? ( wr_stack_esp) :
    ...
    (cond_129)? ( wr_stack_esp) :
    (cond_130)? ( wr_stack_esp) :
    (cond_131 && cond_10)? ( wr_stack_esp) :
    (cond_136)? ( wr_stack_esp) :
    ...
    esp;
assign ebp_to_reg =
    (cond_130)? ( { wr_operand_16bit? ebp[31:16] : exe_buffer[31:16], exe_buffer[15:0] }) :
    (cond_136)? ( { wr_operand_16bit? ebp[31:16] : result_push[31:16], result_push[15:0] }) :
...
assign oflag_to_reg =
    ...
    (cond_107 && cond_34)? ( oflag_arith) :
    (cond_132 && cond_1)? ( `FALSE) :
    (cond_132 && ~cond_1)? ( oflag_arith) :
    (cond_133)? ( wr_mult_overflow) :
    (cond_135 && cond_105)? ( result_signals[1]) :
    (cond_139)? ( oflag_arith) :
    (cond_144)? ( wr_mult_overflow) :
    (cond_145)? ( oflag_arith) :
    (cond_216)? (  result2[11]) :
    (cond_240)? (  task_eflags[11]) :
    (cond_272)? ( oflag_arith) :
    (cond_273)? ( oflag_arith) :
    (cond_274 && ~cond_1)? ( oflag_arith) :
    oflag;
assign ss_to_reg =
    ...
    ss;
assign ebx_to_reg =
    (cond_171 && cond_172)? ( "ineG") :
    (cond_171 && cond_173)? ( 32'h00010000) :
...
assign eax_to_reg =
    ...
    (cond_132 && ~cond_1)? ( (wr_is_8bit)? { eax[31:8], result2[7:0] } : (wr_operand_16bit)? { eax[31:16], result2[15:0] } : result2) :
    (cond_133 && cond_134)? ( (wr_is_8bit || wr_operand_16bit)? { eax[31:16], result[15:0] } : result) :
    (cond_144 && cond_134)? ( (wr_is_8bit || wr_operand_16bit)? { eax[31:16], result[15:0] } : result) :
    (cond_152 && cond_34)? ( (wr_is_8bit)? { eax[31:8], result2[7:0] } : (wr_operand_16bit)? { eax[31:16], result2[15:0] } : result2) :
    (cond_155)? ( (wr_operand_16bit)? { eax[31:16], result2[15:0] } : result2) :
    (cond_164 && cond_165)? ( (wr_is_8bit)? { eax[31:8], result2[7:0] } : (wr_operand_16bit)? { eax[31:16], result2[15:0] } : result2) :
    (cond_171 && cond_172)? ( 32'd1) :
    (cond_171 && cond_173)? ( `CPUID_MODEL_FAMILY_STEPPING) :
...
assign dr6_bs_to_reg =
    ...
    dr6_bs;
assign edi_to_reg =
    (cond_33 && cond_34)? ( wr_edi_final) :
    (cond_107 && cond_34)? ( wr_edi_final) :
    (cond_192 && cond_34 && ~cond_9)? ( wr_edi_final) :
    (cond_196 && ~cond_197 && cond_34 && ~cond_9)? ( wr_edi_final) :
    (cond_240)? ( (glob_descriptor[`DESC_BITS_TYPE] <= 4'd3)? { 16'hFFFF, exe_buffer_shifted[127:112] } : exe_buffer_shifted[143:112]) :
    (cond_261 && cond_34 && ~cond_9)? ( wr_edi_final) :
...
assign iflag_to_reg =
    (cond_49)? (  `FALSE) :
    (cond_51)? (  (glob_param_1[20] == 1'b0)? `FALSE : iflag) :
    (cond_52)? (  (glob_param_3[20] == 1'b0)? `FALSE : iflag) :
...
assign sflag_to_reg =
    ...
    (cond_32)? ( sflag_result) :
    (cond_33 && cond_34)? ( sflag_result) :
    (cond_65)? ( eax[15]) :
    ...
    (cond_107 && cond_34)? ( sflag_result) :
    (cond_132 && cond_1)? ( `FALSE) :
    (cond_132 && ~cond_1)? ( sflag_result) :
    (cond_133)? ( sflag_result) :
    (cond_135 && cond_104)? ( sflag_result) :
    (cond_139)? ( sflag_result) :
    (cond_144)? ( sflag_result) :
    (cond_145)? ( sflag_result) :
    (cond_216)? (  result2[7]) :
    (cond_240)? (  task_eflags[7]) :
    (cond_272)? ( sflag_result) :
    (cond_273)? ( sflag_result) :
    (cond_274 && ~cond_1)? ( sflag_result) :
    sflag;
assign edx_to_reg =
    ...
    (cond_144 && cond_134 && cond_101)? ( (wr_operand_16bit)? { edx[31:16], result[31:16] } : result2) :
    (cond_171 && cond_172)? ( "Aenu") :
    (cond_171 && cond_173)? ( 32'd0) :
...
assign rflag_to_reg =
    ...
    rflag;
assign esi_to_reg =
    (cond_107 && cond_34)? ( wr_esi_final) :
    (cond_152 && cond_34)? ( wr_esi_final) :
    (cond_200 && ~cond_201 && cond_34 && ~cond_202)? ( wr_esi_final) :
    (cond_240)? ( (glob_descriptor[`DESC_BITS_TYPE] <= 4'd3)? { 16'hFFFF, exe_buffer_shifted[159:144] } : exe_buffer_shifted[175:144]) :
    (cond_261 && cond_34 && ~cond_9)? ( wr_esi_final) :
...
assign aflag_to_reg =
    ...
    (cond_107 && cond_34)? ( aflag_arith) :
    (cond_132 && cond_1)? ( `FALSE) :
    (cond_132 && ~cond_1)? ( aflag_arith) :
    (cond_133)? ( 1'b0) :
    (cond_135 && cond_104)? ( aflag_arith) :
    ...
    (cond_274 && ~cond_1)? ( aflag_arith) :
    aflag;
assign ecx_to_reg =
    (cond_33 && cond_34 && cond_35)? ( wr_ecx_final) :
    (cond_107 && cond_34 && cond_35)? ( wr_ecx_final) :
    (cond_142 && cond_143)? ( { ecx[31:16], wr_ecx_minus_1[15:0] }) :
    (cond_142 && ~cond_143)? ( wr_ecx_minus_1) :
    (cond_152 && cond_34 && cond_35)? ( wr_ecx_final) :
    (cond_171 && cond_172)? ( "684O") :
    (cond_171 && cond_173)? ( 32'd0) :
    (cond_192 && cond_34 && ~cond_9 && cond_35)? ( wr_ecx_final) :
    (cond_196 && ~cond_197 && cond_34 && ~cond_9 && cond_35)? ( wr_ecx_final) :
    (cond_200 && ~cond_201 && cond_34 && ~cond_202 && cond_35)? ( wr_ecx_final) :
    (cond_240)? ( (glob_descriptor[`DESC_BITS_TYPE] <= 4'd3)? { 16'hFFFF, exe_buffer_shifted[319:304] } : exe_buffer_shifted[335:304]) :
    (cond_261 && cond_34 && ~cond_9 && cond_35)? ( wr_ecx_final) :
...
assign pflag_to_reg =
    ...
    (cond_32)? ( pflag_result) :
    (cond_33 && cond_34)? ( pflag_result) :
    (cond_65)? ( eax[10]) :
    ...
    (cond_107 && cond_34)? ( pflag_result) :
    (cond_132 && cond_1)? ( `TRUE) :
    (cond_132 && ~cond_1)? ( pflag_result) :
    (cond_133)? ( pflag_result) :
    (cond_135 && cond_104)? ( pflag_result) :
    (cond_139)? ( pflag_result) :
    (cond_144)? ( pflag_result) :
    (cond_145)? ( pflag_result) :
    (cond_216)? (  result2[2]) :
    (cond_240)? (  task_eflags[2]) :
    (cond_272)? ( pflag_result) :
    (cond_273)? ( pflag_result) :
    (cond_274 && ~cond_1)? ( pflag_result) :
    pflag;
...
assign cflag_to_reg =
    ...
    (cond_107 && cond_34)? ( cflag_arith) :
    (cond_132 && cond_1)? ( `FALSE) :
    (cond_132 && ~cond_1)? ( cflag_arith) :
    (cond_133)? ( wr_mult_overflow) :
    (cond_135 && cond_105)? ( result_signals[0]) :
...
assign wr_seg_rpl =
    ...
    (cond_244 && cond_251 && cond_53)? (      2'd3) :
    2'd0;
...
assign wr_waiting =
    ...
    (cond_24 && cond_3)? (`TRUE) :
    (cond_32 && cond_3)? (`TRUE) :
    (cond_39 && cond_1 && cond_3)? (`TRUE) :
    (cond_43 && cond_9)? (`TRUE) :
    (cond_44 && cond_9)? (`TRUE) :
    (cond_54 && cond_9)? (`TRUE) :
    (cond_70 && cond_71 && cond_72 && cond_9)? (`TRUE) :
    (cond_78 && cond_79 && cond_3)? (`TRUE) :
    (cond_98 && cond_3)? (`TRUE) :
    (cond_102 && cond_103 && cond_3)? (`TRUE) :
    (cond_109 && cond_3)? (`TRUE) :
    (cond_124 && cond_9)? (`TRUE) :
    (cond_128 && cond_3)? (`TRUE) :
    (cond_129 && cond_9)? (`TRUE) :
    (cond_131 && cond_9)? (`TRUE) :
    (cond_132 && cond_1 && cond_3)? (`TRUE) :
    (cond_135 && cond_103 && cond_3)? (`TRUE) :
    (cond_139 && cond_140)? (`TRUE) :
    (cond_156 && cond_3)? (`TRUE) :
    ...
    (cond_192 && cond_34 && cond_9)? (`TRUE) :
    (cond_196 && ~cond_197 && cond_34 && cond_9)? (`TRUE) :
    (cond_199 && cond_9)? (`TRUE) :
    (cond_200 && ~cond_201 && cond_34 && cond_202)? (`TRUE) :
    (cond_210 && cond_211 && cond_202)? (`TRUE) :
    (cond_212 && cond_3)? (`TRUE) :
...
assign write_stack_virtual =
    ...
    (cond_54 && cond_10)? (`TRUE) :
    (cond_124 && cond_10)? (`TRUE) :
    (cond_129 && cond_10)? (`TRUE) :
    (cond_131 && cond_10)? (`TRUE) :
    (cond_158 && cond_10)? (`TRUE) :
    (cond_189 && cond_10)? (`TRUE) :
    (cond_199 && cond_10)? (`TRUE) :
...
assign wr_error_code =
    ...
    (cond_43)? ( (glob_param_1[`SELECTOR_BITS_RPL] != cpl)? `SELECTOR_FOR_CODE(glob_param_1) : 16'd0) :
    (cond_44)? ( (glob_param_1[`SELECTOR_BITS_RPL] != cpl)? `SELECTOR_FOR_CODE(glob_param_1) : 16'd0) :
    16'd0;
assign write_string_es_virtual =
    (cond_192 && cond_34 && cond_193)? (`TRUE) :
    (cond_196 && ~cond_197 && cond_34)? (`TRUE) :
    (cond_261 && cond_34 && cond_193)? (`TRUE) :
    1'd0;
...
assign wr_not_finished =
    ...
    (cond_190)? (`TRUE) :
    (cond_191)? (`TRUE) :
    (cond_192 && cond_34 && ~cond_9 && ~cond_194 && cond_35)? (`TRUE) :
    (cond_196 && cond_197)? (`TRUE) :
    (cond_196 && ~cond_197 && cond_34 && ~cond_9 && ~cond_198)? (`TRUE) :
    (cond_200 && cond_201)? (`TRUE) :
    (cond_200 && ~cond_201 && cond_34 && ~cond_202 && ~cond_198)? (`TRUE) :
    (cond_203)? (`TRUE) :
    (cond_205)? (`TRUE) :
    (cond_206)? (`TRUE) :
    (cond_207)? (`TRUE) :
    ...
    (cond_253)? (`TRUE) :
    (cond_258 && cond_259)? (`TRUE) :
    (cond_261 && cond_34 && ~cond_9 && ~cond_194 && cond_35)? (`TRUE) :
    (cond_263 && ~cond_264)? (`TRUE) :
    (cond_266)? (`TRUE) :
    1'd0;
...
assign wr_req_reset_rd =
    ...
    (cond_178)? (`TRUE) :
    (cond_182)? (`TRUE) :
    (cond_192 && cond_34 && ~cond_9 && cond_194)? (`TRUE) :
    (cond_192 && cond_195)? (`TRUE) :
    (cond_196 && ~cond_197 && cond_34 && ~cond_9 && cond_198)? (`TRUE) :
    (cond_196 && ~cond_197 && cond_195)? (`TRUE) :
    (cond_200 && ~cond_201 && cond_34 && ~cond_202 && cond_198)? (`TRUE) :
    (cond_200 && ~cond_201 && cond_195)? (`TRUE) :
    (cond_204)? (`TRUE) :
    (cond_210 && cond_211 && ~cond_202)? (`TRUE) :
    (cond_216)? (`TRUE) :
    (cond_255)? (`TRUE) :
    (cond_261 && cond_34 && ~cond_9 && cond_194)? (`TRUE) :
...
assign write_regrm =
    ...
    (cond_32)? (         wr_dst_is_implicit_reg || wr_dst_is_rm) :
    (cond_39 && cond_1)? (         wr_dst_is_rm) :
    (cond_40)? (`TRUE) :
    (cond_59)? (`TRUE) :
    ...
    (cond_132 && cond_1)? (             wr_dst_is_rm) :
    (cond_133)? ( wr_dst_is_reg) :
    (cond_135 && cond_103)? (         wr_dst_is_rm) :
    (cond_139 && cond_141)? (        wr_dst_is_reg || wr_dst_is_rm) :
    (cond_144)? ( wr_dst_is_reg) :
    (cond_155)? (`TRUE) :
    (cond_156)? (             wr_dst_is_rm) :
    (cond_157)? (`TRUE) :
    (cond_167 && cond_168)? (`TRUE) :
    (cond_170)? (         wr_dst_is_rm) :
...
assign write_rmw_virtual =
    (cond_2)? (       wr_dst_is_memory) :
    (cond_24)? (   wr_dst_is_memory) :
    (cond_32)? (   wr_dst_is_memory) :
    (cond_39 && cond_1)? (   wr_dst_is_memory) :
    (cond_78 && cond_79)? (   wr_dst_is_memory) :
    (cond_102 && cond_103)? (   wr_dst_is_memory) :
    (cond_132 && cond_1)? (       wr_dst_is_memory) :
    (cond_135 && cond_103)? (   wr_dst_is_memory) :
    (cond_139 && cond_141)? (  wr_dst_is_memory) :
    (cond_156)? (       wr_dst_is_memory) :
    (cond_170)? (   wr_dst_is_memory) :
    1'd0;
...
assign wr_push_length_word =
    ...
    (cond_21)? (`TRUE) :
    (cond_43)? (  ~(glob_param_3[19])) :
    (cond_44)? ( ~(glob_param_3[19])) :
    (cond_54)? (`TRUE) :
...
assign write_seg_rpl =
    ...
    (cond_180 && cond_181 && ~cond_9)? (`TRUE) :
    (cond_180 && ~cond_181)? (`TRUE) :
    (cond_244 && cond_251 && cond_53)? (`TRUE) :
    1'd0;
...
assign wr_one_cycle_wait =
    ...
    (cond_158)? (`TRUE) :
    (cond_189)? (`TRUE) :
    (cond_192 && cond_34)? (`TRUE) :
    (cond_199)? (`TRUE) :
    (cond_253 && cond_254)? (`TRUE) :
    (cond_261 && cond_34)? (`TRUE) :
    1'd0;
assign wr_regrm_dword =
    ...
    1'd0;
assign write_io =
    (cond_200 && ~cond_201 && cond_34)? (`TRUE) :
    (cond_210 && cond_211)? (`TRUE) :
    1'd0;
assign write_eax =
...
assign write_new_stack_virtual =
    ...
    (cond_43 && cond_15)? (`TRUE) :
    (cond_44 && cond_15)? (`TRUE) :
    1'd0;
